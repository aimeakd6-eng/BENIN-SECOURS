    ...
    <div className="flex h-screen flex-col" style={{ backgroundColor: "var(--color-bg)" }}>
      ...
      <main className="flex-1 overflow-y-auto px-4 py-5">
        ...
        <button
          ...
          className="group relative mb-3 flex w-full flex-col items-center justify-center gap-3 rounded-2xl p-7 shadow-md transition-all active:scale-[0.97]"
          style={{ backgroundColor: "var(--color-orange)" }}
        >
          <span className="text-5xl">🏍️</span>
          <span className="text-lg font-bold text-white">JE SUIS EN MOTO</span>
          <span className="text-xs text-white/70">Dépannage moto et 2 roues</span>
        </button>
        ...
        <button
          ...
          className="group relative flex w-full flex-col items-center justify-center gap-3 rounded-2xl p-7 shadow-md transition-all active:scale-[0.97]"
          style={{ backgroundColor: "var(--color-primary)" }}
        >
          <span className="text-5xl">🚗</span>
          <span className="text-lg font-bold text-white">JE SUIS EN VÉHICULE</span>
          <span className="text-xs text-white/70">Dépannage voiture et camion</span>
        </button>
      </main>

        ...
        <div className="rounded-2xl bg-white p-5 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold text-gray-900">{prestataire.prenom} {prestataire.nom}</h2>
          ...
          <div className="mt-4 space-y-2 border-t border-gray-100 pt-4 text-sm">
            <div className="flex items-center gap-3 text-gray-500">
              <MapPin className="h-4 w-4 text-gray-400" />{prestataire.type_service}
            </div>
            <div className="flex items-center gap-3 text-gray-500">
              <Navigation className="h-4 w-4 text-gray-400" />{prestataire.adresse || "Adresse non renseignée"}
            </div>
          </div>
        </div>
